package br.com.cams7.apps.desk.action;
 ...
 * código dessa ação só será executado quando a condição <code>boolean</code>
 * for satisfatória (<code>true</code>).
 * </p>
 * 
 * <p>
 ...
 * </p>
 * 
 * @see cams7.action.sjpac.action.BooleanExpression
 * 
...
public final class ConditionalAction extends AbstractAction {
	...
	/**
	 * @return Constrói e retorna uma instância de
	 *         <code>ConditionalAction</code> sem ação e condição definida.
	 */
	 ...
	 * 
	 * @param expression
	 *            condição <code>boolean</code> avaliada por
	 *            <code>ConditionalAction</code>.
	 * @return <code>ConditionalAction</code> com a condição
	 *         <code>boolean</code> definida.
	 */
