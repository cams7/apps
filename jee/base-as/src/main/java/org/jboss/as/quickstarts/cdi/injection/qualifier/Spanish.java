 ...
 * 
 * Qualifiers are special annotations created in a CDI application. The
 * {@link Qualifier} annotation specifies this as a CDI qualifier, which is used
 * during injection to narrow the intended type to be injected.
 * 
